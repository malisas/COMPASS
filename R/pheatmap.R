lo = function(rown, coln, nrow, ncol, cellheight = NA, cellwidth = NA, treeheight_col, treeheight_row, legend, annotation, annotation_colors, annotation_legend, main, fontsize, fontsize_row, fontsize_col,row_annotation,row_annotation_legend,row_annotation_colors, cytokine_annotation, polar=FALSE, cytokine_height_multiplier=1,...){
...
convert_cytokine_annotations <- function(annotation, cytokine_annotation_colors=NULL) {
  ...
  pal <- if(is.null(cytokine_annotation_colors)) {
...
heatmap_motor = function(matrix, border_color, cellwidth, cellheight, tree_col, tree_row, treeheight_col, treeheight_row, filename, width, height, breaks, color, legend, annotation, annotation_colors, annotation_legend, main, fontsize, fontsize_row, fontsize_col, fmat, fontsize_number, row_annotation, row_annotation_legend, row_annotation_colors, cytokine_annotation, headerplot,polar=polar, cytokine_annotation_colors,cytokine_height_multiplier=cytokine_height_multiplier,...){
  grid.newpage()
  if(length(list(...))>0){
  ...
  if(!is.na(cytokine_annotation[[1]][1])){
    pushViewport(vplayout(NULL,2, name="cytokine_annotation"))
    #viewport(layout.pos.row = 6, layout.pos.col = 2, name="cytokine_annotation", height = unit(1, "npc"))
