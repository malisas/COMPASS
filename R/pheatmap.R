lo = function(rown, coln, nrow, ncol, cellheight = NA, cellwidth = NA, treeheight_col, treeheight_row, legend, annotation, annotation_colors, annotation_legend, main, fontsize, fontsize_row, fontsize_col,row_annotation,row_annotation_legend,row_annotation_colors, cytokine_annotation, polar=FALSE, cytokine_height_multiplier,...){
...
convert_cytokine_annotations <- function(annotation, cytokine_annotation_colors=NA) {
  ...
  annot[] <- lapply(annot, function(x) {
    swap(x, -1:7, c("#AAAAAB", "#FFFFFF", pal))
  })
